export const RING_RETICLE_FRAGMENT_SHADER = `
...
void main() {
    ...
    float outer = smoothstep(crossSize + barThickness, crossSize + barThickness - edgeSoftness, dist);
    float inner = smoothstep(crossSize - barThickness, crossSize - barThickness + edgeSoftness, dist);
