export const CROSS_RETICLE_FRAGMENT_SHADER = `
...
void main() {
    ...
    float horiz = smoothstep(barThickness, barThickness - edgeSoftness, absV);
    float vert = smoothstep(barThickness, barThickness - edgeSoftness, absU);
    float cross = max(horiz, vert);
